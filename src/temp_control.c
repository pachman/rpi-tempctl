...
int main(void)
{
    ...
    //Open RGB effect
    setEffectRGB(0x04, 0x03);

    // setEffectRGB(0x08, 0x00);   // close fan
    ...
    while (1)
    {
        ...
        {
            //Open RGB effect
            setEffectRGB(0x04, 0x04);
        }
        else if (count == 20)
        {
            //Open RGB effect
            setEffectRGB(0x04, 0x02);
        }
        else if (count == 30)
        {
            //Open RGB effect
            setEffectRGB(0x04, 0x01);
        }
        else if (count == 40)
        {
            //Open RGB effect
...
{
    setDefaultRGB();
    // wiringPiI2CWriteReg8(fd_i2c, a, b);
}

void setDefaultRGB()
{
    wiringPiI2CWriteReg8(fd_i2c, 0x07, 0x00); // turn off RGB
}
